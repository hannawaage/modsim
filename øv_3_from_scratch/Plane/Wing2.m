function [facPart,vertPart]=Wing1(P,P2,L,Thickness,Chord,R1,R2,NACAName,varargin)
% 
...
xyz1=E*[x(1,:);y(1,:);z(1,:)];
xyz2=E*[x(2,:);y(2,:);z(2,:)];
xe=P2(1)*ones(2,N)+[xyz1(1,:);xyz2(1,:)];
ye=P2(2)*ones(2,N)+[xyz1(2,:);xyz2(2,:)];
ze=P2(3)*ones(2,N)+[xyz1(3,:);xyz2(3,:)];
